...
static inline bool ata_get_ata_identify_wwn_64bit_supported(const char *buf) {
...
static inline bool ata_get_ata_identify_supports_receipt_of_host_initiated_power_management_requests(const char *buf) {
	ata_word_t val = ata_get_word(buf, 76);
	return val & (1 << 9);
}

static inline bool ata_get_ata_identify_supports_receive_fpdma_queued(const char *buf) {
...
static inline unsigned ata_get_ata_identify_queue_depth(const char *buf) {
...
static inline bool ata_get_ata_identify_streaming_supported(const char *buf) {
	ata_word_t val = ata_get_word(buf, 84);
	return val & (1 << 4);
}

static inline bool ata_get_ata_identify_download_microcode_supported(const char *buf) {
...
static inline bool ata_get_ata_identify_puis_supported(const char *buf) {
	ata_word_t val = ata_get_word(buf, 83);
	return val & (1 << 5);
}
...
static inline bool ata_get_ata_identify_supports_host_automatic_partial_to_slumber(const char *buf) {
	ata_word_t val = ata_get_word(buf, 76);
	return val & (1 << 13);
}

static inline bool ata_get_ata_identify_cfa_supported(const char *buf) {
	ata_word_t val = ata_get_word(buf, 83);
	return val & (1 << 2);
}
...
static inline bool ata_get_ata_identify_supports_dev_automatic_partial_to_slumber(const char *buf) {
	ata_word_t val = ata_get_word(buf, 76);
	return val & (1 << 14);
}

static inline unsigned ata_get_ata_identify_current_negotiated_link_speed(const char *buf) {
	ata_word_t val = ata_get_word(buf, 77);
	return (val >> 1) & ((1<<(3 - 1 + 1)) - 1);
}

static inline bool ata_get_ata_identify_supports_sata_gen2_3gbps(const char *buf) {
	ata_word_t val = ata_get_word(buf, 76);
	return val & (1 << 2);
}
...
static inline bool ata_get_ata_identify_supports_ncq_priority(const char *buf) {
	ata_word_t val = ata_get_word(buf, 76);
	return val & (1 << 12);
}
...
static inline bool ata_get_ata_identify_apm_supported(const char *buf) {
	ata_word_t val = ata_get_word(buf, 83);
	return val & (1 << 3);
}
...
static inline bool ata_get_ata_identify_gpl_supported(const char *buf) {
	ata_word_t val = ata_get_word(buf, 84);
	return val & (1 << 5);
}
...
static inline bool ata_get_ata_identify_spin_up_supported(const char *buf) {
	ata_word_t val = ata_get_word(buf, 83);
	return val & (1 << 6);
}
...
static inline bool ata_get_ata_identify_supports_sata_gen3_6gbps(const char *buf) {
	ata_word_t val = ata_get_word(buf, 76);
	return val & (1 << 3);
}
...
static inline bool ata_get_ata_identify_supports_ncq_queue_management_commands(const char *buf) {
	ata_word_t val = ata_get_word(buf, 77);
	return val & (1 << 5);
}
...
static inline bool ata_get_ata_identify_supports_sata_phy_event_counters_log(const char *buf) {
	ata_word_t val = ata_get_word(buf, 76);
	return val & (1 << 10);
}

static inline bool ata_get_ata_identify_supports_ncq(const char *buf) {
	ata_word_t val = ata_get_word(buf, 76);
	return val & (1 << 8);
}

static inline bool ata_get_ata_identify_supports_ncq_streaming(const char *buf) {
	ata_word_t val = ata_get_word(buf, 77);
	return val & (1 << 4);
}
...
static inline bool ata_get_ata_identify_supports_unload_while_ncq_outstanding(const char *buf) {
	ata_word_t val = ata_get_word(buf, 76);
	return val & (1 << 11);
}
